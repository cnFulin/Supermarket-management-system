          ...
          <el-col :span="4">
            <div class="grid-content bg-purple-light">
              <el-form-item label="关键字" prop="keyword">
                <el-input type="text" v-model="ruleForm.keyword" autocomplete="off"></el-input>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="16">
            <div class="grid-content bg-purple-light btn">(商品名称，条形码)
              <el-button type="success" @click="inquire('ruleForm')" size="mini">查询</el-button>
            </div>
          </el-col>
        </el-row>
      </el-form>
      <el-table :data="tableData" style="width: 100%">
        <el-table-column label="商品条形码" width="160">
        ...
        <el-table-column label="进价(元)" width="160">
          <template slot-scope="scope">
        ...
        <el-table-column label="已售" width="160">
          <template slot-scope="scope">
            <span>{{ scope.row.inventory }}</span>
          </template>
        </el-table-column>
